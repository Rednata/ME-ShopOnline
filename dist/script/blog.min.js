...
;// CONCATENATED MODULE: ./src/script/modules/fetchCategories.js
...
const createCategoryItem = (id, title, price, image, discount, category) => {
  ...
  li.insertAdjacentHTML('afterbegin', `<a class="benefit__link" href=${url}>
...
const createCategoryList = categoriesData => {
  const categoriesItem = categoriesData.map(({
    ...
    discount,
    category
  }) => createCategoryItem(id, title, price, image, discount, category));
  const ul = document.createElement('ul');
