...
const createElementsBlog_createFooter = author => {
...
const createElementsBlog_createArticlePage = articleData => {
  const {
    title,
    body,
    user_id
...
const fetch_loadAuthor = async userID => {
...
;// CONCATENATED MODULE: ./src/script/blog.js
